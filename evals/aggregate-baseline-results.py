...
def main():
    ...
    # derived: shunt vs no-resume / resume, tokens and time, % and absolute
    for sc in scenarios:
    ...
    for sc in scenarios:
        ...
        diffs = summary["scenarios"][sc].get("shunt_vs", {})
        for baseline_kind, d in diffs.items():
            print(
                f"{'':<24}shunt vs {baseline_kind:<10} "
